                    ...
                    <p>A wedding commemoration is the festival of adoration, trust, association, resistance and tirelessness. The request shifts for any given year. There is not any more flawless, neighborly and beguiling relationship, fellowship or organization than a decent marriage. Come and enjoy your special day at D2M Hotel.</p>
                     <div class="row">
                        ...
                        <div class="col-md-4" style="margin-top: 20px">
                            <a href='<?php echo e(asset('img/gallery/Anniversary/1.jpg')); ?>'
                               class='fresco'
                               data-fresco-group=' '
                               data-fresco-caption=" ">
                               <figure class="uk-overlay uk-overlay-hover">
                              <img src='<?php echo e(asset('img/gallery/Anniversary/1.jpg')); ?>' alt=''/>
                              <div class="uk-overlay-panel uk-overlay-background uk-overlay-icon"></div>
                              </figure>
                            </a>
                        </div>
                        <div class="col-md-4" style="margin-top: 20px">
                            <a href='<?php echo e(asset('img/gallery/Anniversary/2.jpg')); ?>'
                               class='fresco'
                               data-fresco-group=' '
                               data-fresco-caption=" ">
                               <figure class="uk-overlay uk-overlay-hover">
                              <img src='<?php echo e(asset('img/gallery/Anniversary/2.jpg')); ?>' alt=''/>
                              <div class="uk-overlay-panel uk-overlay-background uk-overlay-icon"></div>
                              </figure>
                            </a>
                        </div>
                        <div class="col-md-4" style="margin-top: 20px">
                            <a href='<?php echo e(asset('img/gallery/Anniversary/3.jpg')); ?>'
                               class='fresco'
                               data-fresco-group=' '
                               data-fresco-caption=" ">
                               <figure class="uk-overlay uk-overlay-hover">
                              <img src='<?php echo e(asset('img/gallery/Anniversary/3.jpg')); ?>' alt=''/>
                              <div class="uk-overlay-panel uk-overlay-background uk-overlay-icon"></div>
                              </figure>
                            </a>
                        </div>
