<?php $__env->startSection('body_id'); ?>
accomodation_page
                        ...
                        <div class="select_room_content clearfix">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <div class="room_thumb">
                                    <a href="#"><img src="<?php echo e(asset('img/excutive.jpg')); ?>" alt=""></a>
                                    <div class="room_details" style="background: rgb(255, 214, 88) none repeat scroll 0 0;
                                        ...
                                        <div class="about_room floatleft">
                                            ...
                                            <div class="room_rent floatleft">
                                                <p style="font-size: 20px;">&nbsp;&nbsp;&nbsp; Rs: 3099<span> / night + taxes</span></p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-sx-12">
                                <div class="room_thumb small_room_thumb margin-bottom-35">
                                    <a href="#"><img src="<?php echo e(asset('img/room-thumb-two.jpg')); ?>" alt=""></a>
                                    
                                </div>
                                <div class="room_thumb small_room_thumb">
                                    <a href="#"><img src="<?php echo e(asset('img/room-thumb-three.jpg')); ?>" alt=""></a>
                                    <div class="room_details" style="background: rgb(255, 214, 88) none repeat scroll 0 0;
                                            padding: 50px;
                                            margin-top:  20px;">
                                        <div class="about_room floatleft">
                                             
                                                <h6><b>Executive Suite Room</b></h6>
                            ...
                            <div class="facilities_name clearfix margin-bottom-45">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <ul class="single_facilities_name clearul">
                                        <li>
                                            <img src="<?php echo e(asset('img/home-facilities-icon-one.png')); ?>" alt="">
                                            <p>Breakfast</p>
                                        </li>
                                        <li>
                                            <img src="<?php echo e(asset('img/home-facilities-icon-four.png')); ?>" alt="">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <ul class="single_facilities_name clearul">
                                        <li>
                                            <img src="<?php echo e(asset('img/home-facilities-icon-two.png')); ?>" alt="">
                                            <p>Air conditioning</p>
                                        </li>
                                        <li>
                                            <img src="<?php echo e(asset('img/gmy.png')); ?>" alt="">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <ul class="single_facilities_name clearul">
                                        <li>
                                            <img src="<?php echo e(asset('img/home-facilities-icon-eight.png')); ?>" alt="">
                                            <p>Free Parking</p>
                                        </li>
                                        <li>
                                            <img src="<?php echo e(asset('img/home-facilities-icon-five.png')); ?>" alt="">
                                            <p>TV LCD</p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <ul class="single_facilities_name clearul ">
                                        <li>
                                            <img src="<?php echo e(asset('img/dry.png')); ?>" alt="">
                                            <p>Dry-cleaning</p>
                                        </li>
                                        <li>
                                            <img src="<?php echo e(asset('img/home-facilities-icon-twelve.png')); ?>" alt="">
                                            <p>Wi-fi service</p>
                                        </li>
                                    </ul>
                                </div>
