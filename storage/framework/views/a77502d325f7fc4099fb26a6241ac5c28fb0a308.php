...
<?php $__env->startSection('body'); ?>
                    ...
                    <div class="fullwidth_home_banner">
                        <ul>                           
                            ...
                            <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one7.jpg')); ?>" alt="slide" > 
                            </li>
                            <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one1.jpg')); ?>" alt="slide" > 
                             
                            </li><li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one3.jpg')); ?>" alt="slide" > 
                            </li><li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one4.jpg')); ?>" alt="slide" > 
                            </li>
                            </li><li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one2.jpg')); ?>" alt="slide" >
                            <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/res.jpg')); ?>" alt="slide" > 
                            </li>
                             <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one.jpg')); ?>" alt="slide" > 
                            </li>
                            <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/wending.jpg')); ?>" alt="slide" > 
                            </li> 
                             <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one8.jpg')); ?>" alt="slide" > 
                            </li> 
                             <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one9.jpg')); ?>" alt="slide" > 
                            </li>
                            <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo e(asset('img/rev-slider/slider-one10.jpg')); ?>" alt="slide" > 
                            </li> 
                                <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                        ...
                        <div class="hotel_booking_area">
                            <div class="container">
                                <div class="hotel_booking">
                                    <form role="form" method="get" action="<?php echo e(route('front.booking')); ?>" class="">
                        ...
                        <div class="row">
                                ...
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo e(asset('img/room-2.jpg')); ?>" alt=""></a>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo e(asset('img/room-3.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="room_title border-bottom-whitesmoke clearfix">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo e(asset('img/room-image-five.png')); ?>" alt=""></a>
                                        </div>
                                        <div class="room_title border-bottom-whitesmoke clearfix">
                                                <div class="left_room_title floatleft">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo e(asset('img/room-4.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="room_title border-bottom-whitesmoke clearfix">
                                            <div class="left_room_title floatleft">
        ...
        <section class="hotel_facilities_area margin-top-115 " style="background: url(<?php echo e(asset ('img/hotel-facilities-bg.jpg')); ?>) no-repeat fixed 0 0;
                        ...
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#restaurant" aria-controls="restaurant" role="tab" data-toggle="tab"><img src="<?php echo e(asset('img/home-facilities-icon-eleven.png')); ?>" alt="restaurant"><span>restaurant</span></a>
                                </li>
                               
                                
                                <li role="presentation">
                                    <a href="#bar" aria-controls="bar" role="tab" data-toggle="tab"><img src="<?php echo e(asset('img/banquet.png')); ?>" alt="bar"><span>Banquets</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#gym" aria-controls="gym" role="tab" data-toggle="tab"><img src="<?php echo e(asset('img/confrence.png')); ?>" alt="confrence"><span>Conference</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#pick-up" aria-controls="pick-up" role="tab" data-toggle="tab"><img src="<?php echo e(asset('img/home-facilities-icon-eight.png')); ?>" alt="sports-club"><span>Parking</span></a>
                                </li>
                                 <li role="presentation">
                                    <a href="#sports-club" aria-controls="sports-club" role="tab" data-toggle="tab"><img src="<?php echo e(asset('img/home-facilities-icon-seven.png')); ?>" alt="sports-club"><span>wifi</span></a>
                                </li>
                            </ul>                           
                                        ...
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5 col-sm-6">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo e(asset('img/hotel-facility-one.jpg')); ?>" alt=""></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo e(asset('img/parking.jpg')); ?>" alt=""></a>
                                                </div>
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="bar">
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo e(asset('img/hotel-facility-three.jpg')); ?>" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="co-lg-7 col-md-7">
                                                <div class="single-tab-details">                                                     
                                 ...
                                 <div role="tabpanel" class="tab-pane" id="sports-club">
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo e(asset('img/wifi.jpg')); ?>" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="co-lg-7 col-md-7">
                                                <div class="single-tab-details">
                                ...
                                <div role="tabpanel" class="tab-pane" id="gym">
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo e(asset('img/meeting.jpg')); ?>" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="co-lg-7 col-md-7">
                                                <div class="single-tab-details">
        ...
        <section class="about_us_area margin-bottom-100 padding-top-50" style="background-color: #eee;">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                       <iframe src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FD2mHotelRestaurant%2Fvideos%2F645307936751756%2F&show_text=false&width=560&t=0" width="100%" height="250" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe> 
                    </div>
                    <div class="col-md-4">
                      <iframe src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FD2mHotelRestaurant%2Fvideos%2F1000763770861463%2F&show_text=false&width=560&t=0" width="100%" height="250" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe>
                    </div>
                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12 thumbnail padding-left-10">
                                        <marquee direction="up" scrollamount="3" onmouseover="this.stop();" onmouseout="this.start();" style="height: 300px;">
                                            <?php $__currentLoopData = App\News::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <p align="justify"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <?php echo $new->news; ?> </p>
                                ...
                                <div class="clearfix demo" style="">
                                    <ul id="vertical" class="gallery list-unstyled">
                                        <li data-thumb="img/lightslider-img/cS-18.jpg">
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-18.jpg')); ?>" />
                                        </li>
                                        <li data-thumb="img/lightslider-img/cS-21.jpg"> 
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-21.jpg')); ?>" />
                                        </li>
                                        <li data-thumb="img/lightslider-img/cS-22.jpg"> 
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-22.jpg')); ?>" />
                                        </li>
                                        <li data-thumb="img/lightslider-img/cS-23.jpg"> 
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-23.jpg')); ?>" />
                                        </li>
                                        <li data-thumb="img/lightslider-img/cS-24.jpg"> 
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-24.jpg')); ?>" />
                                        </li>
                                        <li data-thumb="img/lightslider-img/cS-25.jpg"> 
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-25.jpg')); ?>" />
                                        </li>
                                        <li data-thumb="img/lightslider-img/cS-26.jpg"> 
                                            <img alt="slider" src="<?php echo e(asset('img/lightslider-img/cS-26.jpg')); ?>" />
                                        </li>
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                            ...
                                            <div class="single_says">
                                                ...
                                                <div class="customer_detail clearfix">
                                                    <div class="customer_pic alignleft-20">
                                                        <a href="#"><img src="<?php echo e(asset('img/irfan.png')); ?>" alt=""></a>
                                                    </div>
                                        ...
                                        <div class="item">
                                            <div class="single_says">
                                                ...
                                                <div class="customer_detail clearfix">
                                                    <div class="customer_pic alignleft-20">
                                                        <a href="#"><img src="<?php echo e(asset('img/dinesh.png')); ?>" alt=""></a>
                                                    </div>
                                                    <div class="customer_identity floatleft">
                                                        <h6>DINESH KARTIK</h6>
                                        ...
                                        <div class="item">
                                            <div class="single_says">
                                                ...
                                                <div class="customer_detail clearfix">
                                                    <div class="customer_pic alignleft-20">
                                                        <a href="#"><img src="<?php echo e(asset('img/balaji.png')); ?>" alt=""></a>
                                                    </div>
                                                    <div class="customer_identity floatleft">
                                                        <h6>BALA JI</h6>
                                        ...
                                        <div class="item">
                                            <div class="single_says">
                                                ...
                                                <div class="customer_detail clearfix">
                                                    <div class="customer_pic alignleft-20">
                                                        <a href="#"><img src="<?php echo e(asset('img/gurkit.png')); ?>" alt=""></a>
                                                    </div>
                                                    <div class="customer_identity floatleft">
