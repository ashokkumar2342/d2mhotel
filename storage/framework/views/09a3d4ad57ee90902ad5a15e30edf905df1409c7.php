                                                                      ...
                                                                      <div class="carousel-inner" role="listbox">
                                                                        <div class="item active">
                                                                          <div class="single_item" style="">
                                                                            <img src="<?php echo e(asset('img/lightslider-img/cS-16.jpg')); ?>" alt="">
                                                                          </div>
                                                                        </div>
                                                                        <div class="item">
                                                                          <div class="single_item" style="">
                                                                            <img src="<?php echo e(asset('img/lightslider-img/cS-17.jpg')); ?>" alt="">
                                                                          </div>
                                                                        </div>
                                                                        <div class="item">
                                                                          <div class="single_item" style="">
                                                                            <img src="<?php echo e(asset('img/lightslider-img/cS-18.jpg')); ?>" alt="">
                                                                          </div>
                                                                        </div>
                                                                        <div class="item">
                                                                          <div class="single_item" style="">
                                                                            <img src="<?php echo e(asset('img/lightslider-img/cS-19.jpg')); ?>" alt="">
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                      <!-- Controls -->
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="single_room_wrapper clearfix">
                                                                        <div class="room_wrapper">
                                                                            <div class="dif_room_media">
                                                                                    <a href='<?php echo e(asset('img/gallery-four-b.jpg')); ?>'
                                                                                 class='fresco'
                                                                                 data-fresco-group=' '
                                                                                 data-fresco-caption=" ">
                                                                                <img src='<?php echo e(asset('img/gallery-four.jpg')); ?>' alt=''/>
                                                                              </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-6">
                                                                    <div class="single_room_wrapper clearfix">
                                                                        <div class="room_wrapper">
                                                                            <div class="dif_room_media">
                                                                                <a href='<?php echo e(asset('img/gallery-five-b.jpg')); ?>'
                                                                                 class='fresco'
                                                                                 data-fresco-group=' '
                                                                                 data-fresco-caption=" ">
                                                                                <img src='<?php echo e(asset('img/gallery-five.jpg')); ?>' alt=''/>
                                                                              </a>
                                                    ...
                                                    <div class="single_room_wrapper clearfix">
                                                        <div class="room_wrapper">
                                                            <div class="room_media">
                                                                <a href='<?php echo url('gallery_image/'.$gallery->image); ?>'
                                                                   class='fresco'
                                                                   data-fresco-group=' '
                                                                   data-fresco-caption=" ">
                                                                   <figure class="uk-overlay uk-overlay-hover">
                                                                  <img src='<?php echo url('gallery_image/'.$gallery->image); ?>' alt=' <?php echo url('gallery_image/'.$gallery->title); ?>' style="height: 200px; width: 270px;">
