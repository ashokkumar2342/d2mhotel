...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?php echo e(asset('img/favicon.png')); ?>" sizes="16x16">
    
        <!-- fonts -->
    <link href='http://fonts.googleapis.com/css?family=Playfair+Display:400,700,900' rel='stylesheet' type='text/css'>
        <link href='http://fonts.googleapis.com/css?family=Karla:700,400' rel='stylesheet' type='text/css'>
        <link href='http://fonts.googleapis.com/css?family=Lora:400,700' rel='stylesheet' type='text/css'>
                <script type="text/javascript" src="<?php echo e(asset('http://code.jquery.com/jquery-3.2.1.min.js')); ?>"></script>

        <script type="text/javascript" src="<?php echo e(asset('js/fresco.js')); ?>"></script>

        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/fresco.css')); ?>" />
        ...
        <!-- rev slider -->
        <link rel="stylesheet" href="<?php echo e(asset('css/rev-slider/settings.css')); ?>" />
        <!-- lightslider -->
 ...
 .hotel_facilities_area{
    background: url(<?php echo e(asset ('img/hotel-facilities-bg.jpg')); ?>) no-repeat fixed 0 0;
    ...
    <body id="<?php echo $__env->yieldContent('body_id','home_one'); ?>">
		...
		<!-- rev slider -->
        <script src="<?php echo e(asset('js/rev-slider/rs-plugin/jquery.themepunch.plugins.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/rev-slider/rs-plugin/jquery.themepunch.revolution.js')); ?>"></script>
        <script src="<?php echo e(asset('js/rev-slider/rs.home.js')); ?>"></script>
        <!-- uikit -->
...
<!--End of Tawk.to Script-->
        ...
        <!--[if lte IE 8]>
            <script type="text/javascript" src="<?php echo e(asset('js/ie-opacity-polyfill.js')); ?>"></script>
        <![endif]-->
        <!-- my js -->
